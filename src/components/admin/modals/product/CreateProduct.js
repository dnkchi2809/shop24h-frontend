...
function CreateProduct() {
    ...
    const { openCreateProductModal } = useSelector((reduxData) => reduxData.reducers);
    ...
    const onImageURLInputChange = (event) => {
        newProduct.imageUrl = event.target.value
    }
    ...
    const onConfirmCreateProductClick = () => {
        let validProduct = validateProduct(newProduct);
        ...
        if(validProduct){
            ...
            fetch("https://shop24-backend.herokuapp.com/products", content)
                ...
                .then((data) => {
                    ...
                    if (data.status == "Success 201") {
                        dispatch({
                            ...
                            payload: {
                                openSnackbar: true,
                                alertString: "Create product succesfully"
                            }
                        })
                        dispatch({
                            type: "ALERT_SEVERITY",
    ...
    return (
        <>
            <Modal open={openCreateProductModal} onClose={handleModalClose}>
                <Box style={style}>
                    <Container>
                        ...
                        <Row className="mt-3">
                            ...
                            <Col>
                                <Input onInput={onImageURLInputChange}/>
                            </Col>
                        </Row>
                        <Row className="mt-3">
                            <Col className="col-3">Amount:</Col>
                            <Col>
                                <Input type="number"  onInput={onAmountInputChange}/>
                            </Col>
                        </Row>
                        <Row className="mt-3">
                            <Col className="col-3" >Buy price:</Col>
                            <Col>
                                <Input type="number" onInput={onBuyPriceInputChange}/>
                            </Col>
                        </Row>
                        <Row className="mt-3">
                            <Col className="col-3" >Promotion Price:</Col>
                            <Col>
                                <Input type="number" onInput={onPromotionPriceInputChange}/>
                            </Col>
                        </Row>
